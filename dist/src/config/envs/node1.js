...
exports.createNode1Config = void 0;
const defineConfig_1 = require("../utils/defineConfig");
function createNode1Config() {
    return (0, defineConfig_1.defineConfig)({
        NODE_ENV: "development",
        APP_PORT: 3001,
        API_PORT: 5001,
        PRIVATE_KEY: "a8acad8b4509d7e42a63e695cca4eb995a98bc635406f025e3274abab02e5b88",
        ...
        GENESIS_PRIVATE_KEY: "ad5a70855d86761e227f5100512e55e064e7b284ab89aad1c04347e5c520a2a4",
        MY_ADDRESS: "ws://localhost:3001",
        PEERS: [
            {
                publicKey: "047ef91754d9e78767be0abfa8cec958e8f335e042150e9cc56501df222d04a22ef0509151f15c4caa9d45ba2876d3cf0cf181732e20129c06643d8ed9ee00f6b4",
...
exports.createNode1Config = createNode1Config;
